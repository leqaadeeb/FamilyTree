...
public class FamilyTree {
    ...
    private void addLine(String line) throws TreeException
    {
        ...
        String parent = line.substring(0, colonIndex).trim();// The substring of line that starts at char #0 and ends just before colonIndex. Check the API for 
    ...
    TreeNode getMostRecentCommonAncestor(String name1, String name2) throws TreeException
    {
        ...
        if (node1 == null)
        throw new TreeException("Node not found: " + name1);//??? Throw a TreeException with a useful message
